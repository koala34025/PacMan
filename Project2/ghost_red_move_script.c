...
void ghost_red_move_script(Ghost* ghost, Map* M, Pacman* pacman) {
	if (!movetime(ghost->speed))
		...
		case FLEE: case preFREEDOM:
			...
			break;
		case CRAZE:
			ghost_red_move_script_CRAZE(ghost, M, pacman);
		default:
			break;
		}
...
void ghost_pink_move_script(Ghost* ghost, Map* M, Pacman* pacman) {
	if (!movetime(ghost->speed))
		...
		case FLEE: case preFREEDOM:
			...
			break;
		case CRAZE:
			ghost_pink_move_script_CRAZE(ghost, M, pacman);
			break;
		default:
			break;
		}
...
void ghost_blue_move_script(Ghost* ghost, Map* M, Pacman* pacman) {
	...
	case FLEE: case preFREEDOM:
		...
		break;
	case CRAZE:
		ghost_blue_move_script_CRAZE(ghost, M, pacman);
		break;
	default:
		break;
	}
...
void ghost_orange_move_script(Ghost* ghost, Map* M, Pacman* pacman) {
	...
	case FLEE: case preFREEDOM:
		...
		break;
	case CRAZE:
		ghost_orange_move_script_CRAZE(ghost, M, pacman);
		break;
	default:
		break;
	}
